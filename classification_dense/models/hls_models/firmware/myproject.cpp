...
component output_data myproject(
   input_data inputs
    ...
    nnet::dense_resource<input_t, layer2_t, config2>(inputs.dense_4_input, layer2_out, w2, b2);
    ...
    nnet::sigmoid<layer4_t, result_t, sigmoid_config5>(layer4_out, outputs.layer5_out);
