...
def qmodels_path(i,v): return f"tests/qmodels/qmodels_lr={lr}_patiencES={patience_es}_patienceRLR={patience_rlr}_mindelta{delta},hetero_diffset<{bit_lenghts(i)},{integer}>v{version(v)}.h5"
def qpredicts_path(i,v): return f"tests/qpredicts/qmodels_lr={lr}_patiencES={patience_es}_patienceRLR={patience_rlr}_mindelta{delta},hetero_diffset<{bit_lenghts(i)},{integer}>v{version(v)}.npy"

#path of the qconverted models
def qhist_path(i,v): return f"tests/qhist/qmodels_lr={lr}_patiencES={patience_es}_patienceRLR={patience_rlr}_mindelta{delta},hetero_diffset<{bit_lenghts(i)},{integer}>v{version(v)}.pkl"
...
refmodels_path = f"tests/models/models_patiencES=12_patienceRLR={patience_rlr5}_mindelta{delta}_v4.h5"      
