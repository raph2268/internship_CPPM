...
void myproject_float(
    float q_dense_429_input[N_INPUT_1_1],
    ...
    nnet::convert_data<float, input_t, N_INPUT_1_1>(q_dense_429_input, inputs_ap.q_dense_429_input);
...
void myproject_double(
    double q_dense_429_input[N_INPUT_1_1],
    double layer6_out[N_LAYER_6],
    unsigned short &const_size_in_1,
    unsigned short &const_size_out_1
) {
    input_data inputs_ap;
    nnet::convert_data<double, input_t, N_INPUT_1_1>(q_dense_429_input, inputs_ap.q_dense_429_input);
