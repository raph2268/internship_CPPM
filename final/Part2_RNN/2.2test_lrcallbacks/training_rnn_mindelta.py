...
def models_path(j,v) : return f"tests/models/models_units={units(j)}_mindelta={delta}v{version(v)}.h5"

#path of the tested models 
def predicts_path(j,v) : return f"tests/predicts/models_units={units(j)}_mindelta={delta}v{version(v)}..h5"
