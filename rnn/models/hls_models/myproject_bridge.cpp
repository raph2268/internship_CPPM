...
void myproject_float(
    ...
    nnet::convert_data_back<result_t, float, N_LAYER_3>(outputs_ap.layer4_out, layer4_out);
}
...
void myproject_double(
    ...
    nnet::convert_data_back<result_t, double, N_LAYER_3>(outputs_ap.layer4_out, layer4_out);
}
